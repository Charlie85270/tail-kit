                        ...
                        <div className="flex flex-col md:flex-row w-full items-start justify-start">
                            <div className="sm:text-center z-10 lg:text-left w-full md:w-1/2">
                                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                                    <span className="block xl:inline">Quickly and easily create stunning UI with</span>
                                    <span className="block text-indigo-600 xl:inline"> fastUI</span>
                                </h1>
                                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                                    Fast UI gives you access to over 100 CSS components based on Tailwind css 2.0.
                                    FastUI is free and open source, by the community, for the community.
                                </p>
