...
import TailkitHome from "../../../components/kit/templates/homePage/simplePage/TailkitHome";
import WatchLandingPage from "../../../components/kit/templates/homePage/simplePage/Watch";
...
import NextJs from "../../../components/kit/templates/homePage/simplePage/NextJSHome";
...
const HomePage = () => {
  return (
    ...
    >
      <SectionHeader
        backLink="/templates"
        title="Simple landing page templates"
      />
      <ComponentLayout
        vertical={true}
