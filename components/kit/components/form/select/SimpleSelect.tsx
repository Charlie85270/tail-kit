        ...
        <div className="w-64">
            <div className="mt-1 relative">
                <button
                    ...
                    className="relative w-full bg-white rounded-md shadow-lg pl-3 pr-10 py-4 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                >
                    <span className="flex items-center">
                        <img src="/images/person/2.jpeg" alt="" className="flex-shrink-0 h-8 w-8 rounded-full" />
