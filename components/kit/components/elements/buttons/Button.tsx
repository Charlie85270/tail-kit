  ...
  return (
    <button
      ...
      className={`${props.isFat ? "py-4 px-6 " : "py-2 px-4 "}${
        ...
        colors[props.color]
      } text-white w-full transition ease-in duration-200 text-center text-sm md:text-base font-semibold py-2 px-4 rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 ${
