    ...
    <div className="shadow-lg rounded-xl w-full md:w-80 p-4 bg-white dark:bg-gray-800 relative overflow-hidden">
        ...
        <div className="flex items-center w-full justify-between">
          <div className="flex text-sm flex-col w-full ml-2 items-start justify-between">
            <p className="text-gray-700 dark:text-white">
              <span className="font-bold mr-1">Andrea &nbsp;</span> uploaded 3
              documents on concept deisgn home page
            </p>
      ...
      <div className="flex items-start mb-6 rounded justify-between">
        ...
        <div className="flex items-center w-full justify-between">
          <div className="flex text-sm flex-col w-full ml-2 items-start justify-between">
            <p className="text-gray-700 dark:text-white">
              <span className="font-bold mr-1">Karen &nbsp;</span> leave some
              comments on concept deisgn support page
            </p>
            <p className="text-gray-300">Aug 10</p>
          </div>
        </div>
      ...
      <div className="flex items-start mb-6 rounded justify-between">
        ...
        <div className="flex items-center w-full justify-between">
          <div className="flex text-sm flex-col w-full ml-2 items-start justify-between">
            <p className="text-gray-700 dark:text-white">
              <span className="font-bold mr-1">Karen &nbsp;</span> change
              project description to "SubMarine protection project"
            </p>
      ...
      <div className="flex items-start rounded justify-between">
        ...
        <div className="flex items-center w-full justify-between">
          <div className="flex text-sm flex-col w-full ml-2 items-start justify-between">
            <p className="text-gray-700 dark:text-white">
              <span className="font-bold mr-1">John &nbsp;</span> uploaded 17
              pictures on concept deisgn galery page
            </p>
