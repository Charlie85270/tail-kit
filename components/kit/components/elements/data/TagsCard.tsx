  ...
  return (
    <div className="overflow-hidden shadow-lg rounded-2xl h-90 w-64  m-auto">
      ...
      <div className="bg-white w-full p-4 relative">
        <button type="button" className="absolute rounded-full bg-indigo-500 text-white w-12 h-12 right-8 -top-6">
          <svg
            width="20"
            height="20"
            fill="currentColor"
        ...
        <p className="text-gray-600 text-xs">Dare to take the lead and never let yourself be overtaken by events.</p>
